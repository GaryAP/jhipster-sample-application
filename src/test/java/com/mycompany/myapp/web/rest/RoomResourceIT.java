...
public class RoomResourceIT {
    ...
    public static Room createEntity(EntityManager em) {
        Room room = new Room().roomNumber(DEFAULT_ROOM_NUMBER);
        return room;
    }
    ...
    public static Room createUpdatedEntity(EntityManager em) {
        Room room = new Room().roomNumber(UPDATED_ROOM_NUMBER);
        return room;
    }
    ...
    public void createRoom() throws Exception {
        ...
        // Create the Room
        restRoomMockMvc
            .perform(post("/api/rooms").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(room)))
    ...
    public void getAllRooms() throws Exception {
        ...
        restRoomMockMvc
            .perform(get("/api/rooms?sort=id,desc"))
    ...
    public void getRoom() throws Exception {
        ...
        // Get the room
        restRoomMockMvc
            .perform(get("/api/rooms/{id}", room.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingRoom() throws Exception {
        // Get the room
        restRoomMockMvc.perform(get("/api/rooms/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateRoom() throws Exception {
        ...
        updatedRoom.roomNumber(UPDATED_ROOM_NUMBER);

        restRoomMockMvc
            .perform(put("/api/rooms").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedRoom)))
            .andExpect(status().isOk());
    ...
    public void updateNonExistingRoom() throws Exception {
        ...
        restRoomMockMvc
            .perform(put("/api/rooms").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(room)))
            .andExpect(status().isBadRequest());
    ...
    public void deleteRoom() throws Exception {
        ...
        // Delete the room
        restRoomMockMvc
            .perform(delete("/api/rooms/{id}", room.getId()).accept(MediaType.APPLICATION_JSON))
