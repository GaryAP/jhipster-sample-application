...
public class ResidentResourceIT {
    ...
    public static Resident createEntity(EntityManager em) {
        Resident resident = new Resident().firstName(DEFAULT_FIRST_NAME).lastName(DEFAULT_LAST_NAME).idNumber(DEFAULT_ID_NUMBER);
        return resident;
    }
    ...
    public static Resident createUpdatedEntity(EntityManager em) {
        Resident resident = new Resident().firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).idNumber(UPDATED_ID_NUMBER);
        return resident;
    }
    ...
    public void createResident() throws Exception {
        ...
        // Create the Resident
        restResidentMockMvc
            .perform(post("/api/residents").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(resident)))
    ...
    public void getAllResidents() throws Exception {
        ...
        restResidentMockMvc
            .perform(get("/api/residents?sort=id,desc"))
    ...
    public void getResident() throws Exception {
        ...
        // Get the resident
        restResidentMockMvc
            .perform(get("/api/residents/{id}", resident.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingResident() throws Exception {
        // Get the resident
        restResidentMockMvc.perform(get("/api/residents/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateResident() throws Exception {
        ...
        updatedResident.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).idNumber(UPDATED_ID_NUMBER);

        restResidentMockMvc
            .perform(
                put("/api/residents").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedResident))
            )
            .andExpect(status().isOk());
    ...
    public void updateNonExistingResident() throws Exception {
        ...
        restResidentMockMvc
            .perform(put("/api/residents").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(resident)))
            .andExpect(status().isBadRequest());
    ...
    public void deleteResident() throws Exception {
        ...
        // Delete the resident
        restResidentMockMvc
            .perform(delete("/api/residents/{id}", resident.getId()).accept(MediaType.APPLICATION_JSON))
